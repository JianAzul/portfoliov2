    ...
    return (
        <div className="app-container">
            ...
            <Canvas shadows camera={{ position: [0, 0, 10], fov: 50 }}>
                ...
                <Scene activeCube={null} pageIndex={0} />
                <OrbitControls enableZoom={false} enablePan={false} />
            </Canvas>

            {/* Content */}
            <div style={{ position: 'absolute', top: '30%', left: '50px', zIndex: 10, maxWidth: '50%' }}>
                <h1 className="superhot-text">About</h1>
                <p style={{ marginTop: '20px', fontSize: '18px' }}>
                    This is the About page content. Replace this with your actual about information.
                </p>
            </div>
            ...
            <nav className="navigation">
                ...
                <Link to="/about" className="nav-item active">
                    <span style={{ color: '#ffcc00' }}>▶</span> About
                </Link>
